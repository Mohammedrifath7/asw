...
const BlogDetails = () => {
  ...
  const LatestBlogs = useGetblogsByNameQuery().data;
        ...
        <Box sx={{ borderRadius: "15px", mr: { xs: "0", md: "15px" }, width: { xs: "90%", md: "55%" } }}>
          {data &&
            <>
              ...
              <Box sx={{
                width: "90%", height: "70px", p: "10px", bgcolor: "#F3F2EE", my: "10px", mx: "auto",
        ...
        {LatestBlogs &&
          <Box sx={{ width: "25%", display: { xs: "none", md: "block" } }} >
                  ...
                  >
                    ...
                    <Box sx={{ width: "75%" }} >
                      <Typography variant='h6' sx={{
                        textDecoration: "underline", height: "50px", overflow: "hidden",
            ...
            <Box sx={{ width: "100%", mt: "15px", border: "1px solid black", borderRadius: "15px", p: "10px" }}>
              ...
              <hr />
              {Tags.map((tag) => (
                <Button key={tag.Tag} sx={{ bgcolor: "#F3F2EE", color: "black", m: "5px", borderRadius: "10px", fontSize: "12px" }}>
                  {tag.Tag}
                </Button>
              ))}
            </Box>
